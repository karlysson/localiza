...
ActiveRecord::Schema.define(version: 20180614005318) do

  create_table "aluguels", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "sinistros", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.decimal "preco", precision: 8, scale: 2
    t.decimal "decimal", precision: 8, scale: 2
    t.boolean "status"
    t.integer "tipo"
